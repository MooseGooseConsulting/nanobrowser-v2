...
assertions (not the `it(...)` string) against `docs/STATUS.md`'s claims and the six
...
mutable state); **(f)** a `docs/STATUS.md` "proving test" that doesn't exist, or exists
